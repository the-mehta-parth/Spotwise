        ...
        {showHelp && (
          <div className="bg-blue-50 p-4 rounded-lg mb-8">
            ...
            <p className="text-sm text-gray-600">
              This system uses YOLO object detection to monitor parking spaces in real-time. Green spots indicate
              available spaces, while red spots show occupied ones. The dashboard updates automatically as vehicles
